import { symptomFormBuilderDetails } from "../Utils/InitialState/initialState";
...
export const SET_HOME_RIGHT_SIDE_CONTENT = "THEME_OPTIONS/SET_HOME_RIGHT_SIDE_CONTENT";
export const SET_RIGHT_SIDE_DRAWER = "THEME_OPTIONS/SET_RIGHT_SIDE_DRAWER";
export const SET_POPUP_MODAL = "THEME_OPTIONS/SET_POPUP_MODAL";
...
export const setRightSideDrawer = (
    isRightSideDrawerVisible,
    rightSideDrawerContent,
    rightSideDrawerContentType,
    rightSideDrawerOthers
) => ({
    type: SET_RIGHT_SIDE_DRAWER,
    isRightSideDrawerVisible,
    rightSideDrawerContent,
    rightSideDrawerContentType,
    rightSideDrawerOthers,
...
export const setPopUpModal = (popUpModalContent) => ({
...
export default function reducer(
    state = {
        ...
        isRightSideDrawerVisible: false,
        rightSideDrawerContent: symptomFormBuilderDetails,
        rightSideDrawerContentType: "AddCommonDef",
        rightSideDrawerOthers: {},
        popUpModalContent: {},
    },
    action
    ...
    switch (action.type) {
        ...
        case SET_RIGHT_SIDE_DRAWER: {
            return {
                ...state,
                rightSideDrawerContentType: action.rightSideDrawerContentType,
                rightSideDrawerContent: action.rightSideDrawerContent || state.rightSideDrawerContent,
                isRightSideDrawerVisible: action.isRightSideDrawerVisible,
                rightSideDrawerOthers: action.rightSideDrawerOthers,
            };
        }
        case SET_POPUP_MODAL: {
            return {
                ...state,
                popUpModalContent: action.popUpModalContent,
            };
        }
        default:
            return state;
